 ...
 * Author: Deepak
 *
 * Created on June 6, 2020, 11:08 PM
 */
...
NegotiationData NegotiationHash(NegotiationData secret) {
    ...
    return (NegotiationData) ((s * s) % PUBLIC_KEY);
}
...
NegotiationData NegotiateGenerateBGivenHash(NegotiationData hash_a) {
    //undo the crap math
    NegotiationData negData = (hash_a % PUBLIC_KEY);
    return (sqrt(negData));
}
